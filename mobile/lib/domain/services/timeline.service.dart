...
class TimelineFactory {
  ...
  TimelineService main(List<String> timelineUsers, {PhotoGridFilter filter = const PhotoGridFilter()}) =>
      TimelineService(_timelineRepository.mainWithFilter(timelineUsers, groupBy, filter));
